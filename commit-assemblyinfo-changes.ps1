...
else
{
    ...
    git add "source\nanoFramework.Runtime.Native\Properties\AssemblyInfo.cs"
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/nanoFramework.Runtime.Native/$env:GitVersion_NuGetVersionV2"
    ...
    $assemblyFiles = (Get-ChildItem ".\src\CLR\Runtime.Native\nf_rt_native.cpp" -Recurse)
    ...
    {
        $commitMessage = "Update nanoFramework.Runtime.Native version to $env:GitVersion_AssemblySemFileVer"
