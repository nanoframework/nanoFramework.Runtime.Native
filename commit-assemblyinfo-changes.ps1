...
if ($env:APPVEYOR_REPO_TAG -eq "true")
{
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/nanoFramework.Runtime.Native/$env:MyNuGetVersion"
    ...
    {
        $commitMessage = "Update nanoFramework.Runtime.Native version to $env:MyNuGetVersion"
